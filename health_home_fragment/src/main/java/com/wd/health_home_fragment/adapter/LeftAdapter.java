...
public class LeftAdapter extends RecyclerView.Adapter<LeftAdapter.LeftViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull final LeftAdapter.LeftViewHolder leftViewHolder, final int i) {
        leftViewHolder.left_text.setText(mList.get(i).departmentName);
